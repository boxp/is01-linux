...
help:
	@printf '%s\n' \
		...
		'  make phase3-setup-arch-entry-reset  Build Phase 3 setup_arch entry reset candidate' \
		'  make phase3-setup-arch-entry-reset-verify  Verify Phase 3 setup_arch entry reset candidate' \
		'  make phase3-post-setup-processor-reset  Build Phase 3 post-setup_processor reset candidate' \
		'  make phase3-post-setup-processor-reset-verify  Verify Phase 3 post-setup_processor reset candidate' \
		'  make phase3-machine-desc-resolved-reset  Build Phase 3 machine descriptor resolved reset candidate' \
		'  make phase3-machine-desc-resolved-reset-verify  Verify Phase 3 machine descriptor resolved reset candidate' \
		'  make phase3-pre-setup-machine-fdt-reset  Build Phase 3 pre-setup_machine_fdt reset candidate' \
		'  make phase3-pre-setup-machine-fdt-reset-verify  Verify Phase 3 pre-setup_machine_fdt reset candidate' \
		'  make phase3-post-setup-machine-fdt-reset  Build Phase 3 post-setup_machine_fdt reset candidate' \
		'  make phase3-post-setup-machine-fdt-reset-verify  Verify Phase 3 post-setup_machine_fdt reset candidate' \
		'  make phase3-fdt-mdesc-nonnull-reset  Build Phase 3 FDT non-NULL mdesc reset candidate' \
		'  make phase3-fdt-mdesc-nonnull-reset-verify  Verify Phase 3 FDT non-NULL mdesc reset candidate' \
		'  make phase3-pre-setup-machine-tags-reset  Build Phase 3 pre-setup_machine_tags reset candidate' \
		'  make phase3-pre-setup-machine-tags-reset-verify  Verify Phase 3 pre-setup_machine_tags reset candidate' \
		'  make phase3-post-setup-machine-tags-reset  Build Phase 3 post-setup_machine_tags reset candidate' \
		'  make phase3-post-setup-machine-tags-reset-verify  Verify Phase 3 post-setup_machine_tags reset candidate' \
		'  make phase3-mdesc-null-reset  Build Phase 3 mdesc NULL reset candidate' \
		'  make phase3-mdesc-null-reset-verify  Verify Phase 3 mdesc NULL reset candidate' \
		'  make phase3-deckard-dt-mdesc-reset  Build Phase 3 DECKARD DT mdesc reset candidate' \
		'  make phase3-deckard-dt-mdesc-reset-verify  Verify Phase 3 DECKARD DT mdesc reset candidate' \
		'  make phase3-fdt-verify-ok-reset  Build Phase 3 FDT verify OK reset candidate' \
		'  make phase3-fdt-verify-ok-reset-verify  Verify Phase 3 FDT verify OK reset candidate' \
		'  make phase3-fdt-pointer-nonnull-reset  Build Phase 3 FDT pointer non-NULL reset candidate' \
		'  make phase3-fdt-pointer-nonnull-reset-verify  Verify Phase 3 FDT pointer non-NULL reset candidate' \
		'  make phase3-fdt-magic-reset  Build Phase 3 FDT magic reset candidate' \
		'  make phase3-fdt-magic-reset-verify  Verify Phase 3 FDT magic reset candidate' \
		'  make phase3-atag-core-magic-reset  Build Phase 3 ATAG_CORE magic reset candidate' \
		'  make phase3-atag-core-magic-reset-verify  Verify Phase 3 ATAG_CORE magic reset candidate' \
		'  make phase3-machine-type-deckard-reset  Build Phase 3 MACH_DECKARD machine type reset candidate' \
		'  make phase3-machine-type-deckard-reset-verify  Verify Phase 3 MACH_DECKARD machine type reset candidate' \
		'  make phase3-adb-snapshot  Capture read-only ADB diagnostics from a booted stock/recovery device' \
...
phase3-setup-arch-entry-reset:
	@./scripts/build-phase3-setup-arch-entry-reset.sh

phase3-setup-arch-entry-reset-verify:
	@./scripts/verify-phase3-setup-arch-entry-reset.sh

phase3-post-setup-processor-reset:
	@./scripts/build-phase3-post-setup-processor-reset.sh

phase3-post-setup-processor-reset-verify:
	@./scripts/verify-phase3-post-setup-processor-reset.sh

phase3-machine-desc-resolved-reset:
	@./scripts/build-phase3-machine-desc-resolved-reset.sh

phase3-machine-desc-resolved-reset-verify:
	@./scripts/verify-phase3-machine-desc-resolved-reset.sh

phase3-pre-setup-machine-fdt-reset:
	@./scripts/build-phase3-pre-setup-machine-fdt-reset.sh

phase3-pre-setup-machine-fdt-reset-verify:
	@./scripts/verify-phase3-pre-setup-machine-fdt-reset.sh

phase3-post-setup-machine-fdt-reset:
	@./scripts/build-phase3-post-setup-machine-fdt-reset.sh

phase3-post-setup-machine-fdt-reset-verify:
	@./scripts/verify-phase3-post-setup-machine-fdt-reset.sh

phase3-fdt-mdesc-nonnull-reset:
	@./scripts/build-phase3-fdt-mdesc-nonnull-reset.sh

phase3-fdt-mdesc-nonnull-reset-verify:
	@./scripts/verify-phase3-fdt-mdesc-nonnull-reset.sh

phase3-pre-setup-machine-tags-reset:
	@./scripts/build-phase3-pre-setup-machine-tags-reset.sh

phase3-pre-setup-machine-tags-reset-verify:
	@./scripts/verify-phase3-pre-setup-machine-tags-reset.sh

phase3-post-setup-machine-tags-reset:
	@./scripts/build-phase3-post-setup-machine-tags-reset.sh

phase3-post-setup-machine-tags-reset-verify:
	@./scripts/verify-phase3-post-setup-machine-tags-reset.sh

phase3-mdesc-null-reset:
	@./scripts/build-phase3-mdesc-null-reset.sh

phase3-mdesc-null-reset-verify:
	@./scripts/verify-phase3-mdesc-null-reset.sh

phase3-deckard-dt-mdesc-reset:
	@./scripts/build-phase3-deckard-dt-mdesc-reset.sh

phase3-deckard-dt-mdesc-reset-verify:
	@./scripts/verify-phase3-deckard-dt-mdesc-reset.sh

phase3-fdt-verify-ok-reset:
	@./scripts/build-phase3-fdt-verify-ok-reset.sh

phase3-fdt-verify-ok-reset-verify:
	@./scripts/verify-phase3-fdt-verify-ok-reset.sh

phase3-fdt-pointer-nonnull-reset:
	@./scripts/build-phase3-fdt-pointer-nonnull-reset.sh

phase3-fdt-pointer-nonnull-reset-verify:
	@./scripts/verify-phase3-fdt-pointer-nonnull-reset.sh

phase3-fdt-magic-reset:
	@./scripts/build-phase3-fdt-magic-reset.sh

phase3-fdt-magic-reset-verify:
	@./scripts/verify-phase3-fdt-magic-reset.sh

phase3-atag-core-magic-reset:
	@./scripts/build-phase3-atag-core-magic-reset.sh

phase3-atag-core-magic-reset-verify:
	@./scripts/verify-phase3-atag-core-magic-reset.sh

phase3-machine-type-deckard-reset:
	@./scripts/build-phase3-machine-type-deckard-reset.sh

phase3-machine-type-deckard-reset-verify:
	@./scripts/verify-phase3-machine-type-deckard-reset.sh

phase3-adb-snapshot:
	@./scripts/capture-adb-snapshot.sh phase3
