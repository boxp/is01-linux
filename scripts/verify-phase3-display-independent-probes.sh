...
out_dir='build/phase3/display-independent-probes'
...
check_probe phase3-proc-comm-reset payloads/phase3/proc-comm-reset.S
check_probe phase3-zimage-proc-comm-reset payloads/phase3/zimage-proc-comm-reset.S
check_probe phase3-proc-comm-control-loop payloads/phase3/early-loop.S

check_zimage_header "$out_dir/phase3-zimage-proc-comm-reset.bin"
...
printf 'Phase 3 display-independent candidates verified:\n'
