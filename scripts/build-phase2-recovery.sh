...
ubi_img="$out_dir/phase2-stock-kernel-userspace-recovery.ubi"
recovery_img="$out_dir/phase2-stock-kernel-userspace-recovery.img"
ubinize_cfg="$out_dir/ubinize.cfg"

ramdisk_cpio='build/phase2/initramfs/initramfs.cpio'
partition_size=11534336
volume_payload_size=9547776

test -s "$ramdisk_cpio" || ./scripts/build-phase2-initramfs.sh
