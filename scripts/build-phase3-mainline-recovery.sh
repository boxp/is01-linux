...
boot_payload="$payload_dir/phase3-mainline-minimal-boot.img"
out_dir='build/phase3/recovery'
boot_img="$out_dir/phase3-mainline-minimal-boot.img"
ubi_payload="$out_dir/phase3-mainline-minimal-volume.bin"
ubi_img="$out_dir/phase3-mainline-minimal-recovery.ubi"
recovery_img="$out_dir/phase3-mainline-minimal-recovery.img"
ubinize_cfg="$out_dir/ubinize.cfg"
partition_size=11534336
volume_payload_size=9547776

test -s "$boot_payload" || ./scripts/build-phase3-mainline-boot.sh
...
printf 'Phase 3 mainline recovery candidate is ready:\n'
