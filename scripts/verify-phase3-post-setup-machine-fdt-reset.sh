...
grep -F 'after setup_machine_fdt() returns' "$patch_note" >/dev/null || fail 'patch note does not describe post-setup_machine_fdt return checkpoint'
...
printf 'Phase 3 post-setup-machine-fdt reset candidate verified:\n'
